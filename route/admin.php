...
\W7\Core\Facades\Router::middleware(['AppAuthMiddleware', 'CheckAuthMiddleware'])->group(['prefix' => '/admin'], function (\W7\Core\Route\Router $route) {
	//管理文档列表
	...
	//api文档内容管理-公共
	$route->middleware('BackendDocumentPermissionMiddleware')->group(['prefix' => '/document/chapterapi'], function (\W7\Core\Route\Router $route) {
		$route->get('/getApiLabel', 'Admin\Document\ChapterApiController@getApiLabel');
	});
	//文档内容管理
	$route->middleware('BackendDocumentPermissionMiddleware')->group(['prefix' => '/chapter'], function (\W7\Core\Route\Router $route) {
		//文档管理设置
	...
	$route->middleware('BackendDocumentPermissionMiddleware')->group(['prefix' => '/operate-log'], function (\W7\Core\Route\Router $route) {
	...
	$route->group(['prefix' => '/share'], function (\W7\Core\Route\Router $route) {
		$route->post('/all', 'Admin\UserShareController@all');
		$route->post('/url', 'Admin\UserShareController@shareUrl');
	});

	$route->group(['prefix' => '/user'], function (\W7\Core\Route\Router $route) {
		//文档管理设置
	...
	$route->middleware('BackendDocumentPermissionMiddleware')->group(['prefix' => '/star'], function (\W7\Core\Route\Router $route) {
		//文档管理设置
	...
	$route->middleware('BackendDocumentPermissionMiddleware')->group(['prefix' => '/third-party-login'], function (\W7\Core\Route\Router $route) {
		//文档管理设置
	...
	$route->middleware('BackendDocumentPermissionMiddleware')->group(['prefix' => '/menu'], function (\W7\Core\Route\Router $route) {
		//文档管理设置
	...
	$route->middleware('CheckFounderMiddleware')->group([], function (\W7\Core\Route\Router $route) {
